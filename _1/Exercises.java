...
public class Exercises {
    ...
    private static void exercise2() {
        ...
        for (int i = 0; i < studentNames.size(); i++) {
            student.add(createNewStudent(studentNames.get(i), studentAges.get(i)));
            System.out.println(studentNames.get(i));
            System.out.println(studentAges.get(i));
        }
    ...
    private static void exercise3() {
        ...
        course.maxStudents = 22;
        course.courseName="java";
        int age = 0;
        for (int i = 0; i < studentNames.size(); i++) {
             course.student.add(createNewStudent(studentNames.get(i), studentAges.get(i)));
            age += studentAges.get(i);
        }
        System.out.println(course.student);
        System.out.println("sum age= " + age);
        System.out.println("nome corso= "+course.courseName);
        System.out.println("massimo studenti= "+course.maxStudents);
        // Write your code here
    }
}
